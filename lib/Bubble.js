...
export default class Bubble extends React.Component {
    ...
    renderMessageCalendar() {
        if (this.props.currentMessage && this.props.currentMessage.calendar) {
            const { containerStyle, wrapperStyle, ...messageCalendarProps } = this.props;
            if (this.props.renderMessageCalendar) {
                return this.props.renderMessageCalendar(messageCalendarProps);
            }
            return <MessageCalendar {...messageCalendarProps}/>;
        }
        return null;
    }
    renderMessageAudio() {
...
Bubble.propTypes = {
    ...
    renderMessageCalendar: PropTypes.func,
